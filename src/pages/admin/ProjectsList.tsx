...
export function ProjectsList() {
  ...
  const { projects, projectsLoading, clients } = useData();
      ...
      <div className="space-y-8 pb-20">
        ...
        {projectsLoading ? (
          <div className="text-center py-20">
            <div className="w-16 h-16 border-4 border-toiral-primary border-t-transparent rounded-full animate-spin mx-auto mb-4" />
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              ...
              <Card
                ...
                onClick={() => navigate(`/admin/projects/${project.id}`)}>
                  ...
                  <p className="text-sm text-gray-500 mb-6">{getClientName(project.clientId)}</p>
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-100 flex justify-between items-center">
                    <div className="flex -space-x-2">
                      {(project.teamIds || []).slice(0, 3).map((teamId, i) =>
                    <div
                      key={i}
            ...
            <div className="text-center py-20">
                ...
                <p className="text-gray-500 mb-6">
                  {search || filter !== 'All' ? 'Try adjusting your filters or search.' : 'Get started by creating your first project.'}
                </p>
                {!search && filter === 'All' && (
                  <Button onClick={() => navigate('/admin/clients/new')}>
